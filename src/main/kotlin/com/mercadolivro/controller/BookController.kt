...
class BookController(
    ...
    @PostMapping
    fun create(@RequestBody @Valid request: PostBookRequest): ResponseEntity<BookResponse> {
    ...
    @PutMapping
    fun update(@RequestBody @Valid request: PutBookRequest): ResponseEntity<Void> {
